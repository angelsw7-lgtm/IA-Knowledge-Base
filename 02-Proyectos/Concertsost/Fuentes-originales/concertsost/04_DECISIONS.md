...
- **Añadido Instagram**: icono en el nav (único elemento social en el encabezado) y, al final de la página antes del footer, una sección dedicada "El ecosistema, también en Instagram" con botón de seguir — sin texto genérico de "síguenos en redes" sueltos por otras zonas. https://www.instagram.com/concert.sost
